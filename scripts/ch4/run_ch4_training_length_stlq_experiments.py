# ==============================================================================
# Description:
#   Run Chapter 4 STL-Q training-length controlled experiments.
#
# Purpose:
#   Provide single-task streamflow baselines for evaluating whether CGC remains
#   beneficial under different training data lengths.
# ==============================================================================
...
def build_config(length_name: str, train_period: List[str]) -> Path:
    """Build one temporary STL-Q config for one training-length experiment."""
    cfg = load_yaml(BASE_CONFIG)
    cfg = apply_stlq_config(cfg)

    run_name = f"ch4_length_{length_name}_stlq_seed42"
...
def main() -> None:
    """Run all STL-Q training-length experiments."""
    ...
    print("All Chapter 4 STL-Q training-length experiments completed.")
