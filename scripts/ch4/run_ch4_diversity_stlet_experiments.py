# ==============================================================================
# Description:
#   Run Chapter 4 STL-ET basin-diversity controlled experiments.
#
# Purpose:
#   Provide single-task evapotranspiration baselines for evaluating CGC
#   evapotranspiration performance under different training-basin diversity
#   levels.
# ==============================================================================
...
def build_config(group_name: str, basin_list_path: Path) -> Path:
    """Build one temporary STL-ET config for one basin-diversity group."""
    cfg = load_yaml(BASE_CONFIG)
    cfg = apply_stlet_config(cfg)

    run_name = f"ch4_diversity_{group_name}_stlet_seed42"
...
def main() -> None:
    """Run all STL-ET basin-diversity experiments."""
    ...
    print("All Chapter 4 STL-ET basin-diversity experiments completed.")
