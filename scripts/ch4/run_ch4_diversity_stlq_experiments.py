# ==============================================================================
# Description:
#   Run Chapter 4 STL-Q basin-diversity controlled experiments.
#
# Purpose:
#   Provide single-task streamflow baselines for evaluating CGC robustness under
#   different training-basin diversity levels.
# ==============================================================================
...
def build_config(group_name: str, basin_list_path: Path) -> Path:
    """Build one temporary STL-Q config for one basin-diversity group."""
    cfg = load_yaml(BASE_CONFIG)
    cfg = apply_stlq_config(cfg)

    run_name = f"ch4_diversity_{group_name}_stlq_seed42"
...
def main() -> None:
    """Run all STL-Q basin-diversity experiments."""
    ...
    print("All Chapter 4 STL-Q basin-diversity experiments completed.")
