# ==============================================================================
# Description:
#   Run Chapter 4 climate-consistency controlled experiments.
#
# Purpose:
#   Train CGC models on low/medium/high train-test climate consistency basin
#   groups. Basin groups are generated by build_data_consistency_groups.py using
#   joint P-T-PET climate feature distance.
# ==============================================================================
...
def build_config(group_name: str, basin_list_path: Path) -> Path:
    """Build one temporary config for one climate-consistency group."""
    cfg = load_yaml(BASE_CONFIG)
    run_name = f"ch4_consistency_{group_name}_cgc_seed42"
...
def main() -> None:
    """Run all climate-consistency experiments."""
    ...
    print("All Chapter 4 climate-consistency experiments completed.")
