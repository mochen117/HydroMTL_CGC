...
class DatasetBuilder:
    ...
    def save_basin_dataset(self, dataset: xr.Dataset, basin_id: str) -> bool:
        ...
        try:
            ...
            logger.debug("Saved dataset for basin %s to %s", basin_id, file_path)
            return True
            
        except Exception as e:
            logger.error("Failed to save dataset for basin %s: %s", basin_id, str(e))
            return False
        ...
        try:
            ...
            for basin_id in basin_ids:
                ...
                if basin_dataset is not None:
                    # Add basin dimension
                    basin_dataset = basin_dataset.expand_dims({'basin': [basin_id]})
            ...
            logger.info("Combined %d basins into single dataset", len(datasets))
    ...
    def _load_basin_dataset(self, basin_id: str) -> Optional[xr.Dataset]:
        ...
        try:
            ...
            logger.warning("Failed to load dataset for basin %s: %s", basin_id, str(e))
            return None