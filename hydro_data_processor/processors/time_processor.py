...
class TimeProcessor:
    ...
    def process_modis_8day_composite(
            self, modis_df: pd.DataFrame) -> pd.DataFrame:
        """
        ...
        for _, row in modis_df.iterrows():
            ...
            # Calculate daily average ET (sum over period divided by period
            # length)
